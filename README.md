...
- Inital a empty next.js
- setup providers
- Auth providers with usefull hooks + basic apis
- Tanstack query
- after provider setup build and run with fresh
- font setup as needed
- setup custom tailwind extend classes if need
...
- here this Component split as much possible for Server-rendering and Optimizations code and clean code and reduce Repetition for better renderation boost and fast, best way Optimizations and keep mind nothing should be break logic or design carefull. my main foucs of spliting is make as much possible server side rendaring and SEO friendly add seo boost
