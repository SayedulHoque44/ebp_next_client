...
/**
 * DrivingLicenceCTA Component (Client Component)
 * 
 * Call-to-action section with animations.
 * Client component for framer-motion animations and interactions.
 */
const DrivingLicenceCTA = () => {
  return (
    <motion.div
...
export default DrivingLicenceCTA;
