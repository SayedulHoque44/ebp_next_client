...
const SimulazioneEsame = () => {
  ...
  } = QuizHooks.useGetSingleUserQuizStatistics({
    queryKey: [QUERY_KEY.SINGLE_USER_QUIZ_STATISTICS, user?._id || ""],
  ...
  const [quizType, setQuizType] = useState<"fixed" | "personalized">("fixed");
  ...
  } = QuizHooks.useGetRandomThirtyQuizzes({
