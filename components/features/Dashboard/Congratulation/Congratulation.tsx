...
import rewardsIcon from "@/public/assets/Images/rewards.png";
import { Sparkle } from "@phosphor-icons/react";
import Button from "@/components/ui/Button";

const Congratulation = memo(() => {
  return (
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-4 md:space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-md">
            Your hard work and dedication have paid off. We&apos;re proud of
            your achievement!
          </p>
        </div>
        ...
        {/* Button */}
        <div className="pt-2">
          <Button>Give Feedback please!</Button>
        </div>
      </div>
    </div>
  );
...
Congratulation.displayName = "Congratulation";
