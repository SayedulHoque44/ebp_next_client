...
// import pp from "../../assets/Images/privacy-policy.png";
  ...
  return (
    <Container>
      <div className="space-y-10 py-10">
        <div>
          <h1 className="text-4xl mb-2 flex gap-2 items-center">
            <span>Privacy Policy</span>
            <Image
              src={mediaProvider.privacyPolicy}
              className="h-14"
              alt="privacy policy"
              width={100}
              height={100}
        ...
        <div>
          <h1 className="text-4xl mb-2 flex gap-2 items-center">
            <span>Interpretation and Definitions Interpretation</span>
            <Image
              src={mediaProvider.check}
              className="h-10"
              alt="check"
              width={100}
              height={100}
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Definitions</h1>
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Usage Data</h1>
          <p className="text-lg">
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Use of Your Personal Data</h1>
          <p className="text-lg">
          ...
          <ul className="text-lg list-disc ml-10 space-y-3">
            ...
            <li>
              <b>With business partners:</b>With business partners: We may share
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Retention of Your Personal Data</h1>
          <p className="text-lg">
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Transfer of Your Personal Data</h1>
          <p className="text-lg">
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Delete Your Personal Data</h1>
          <p className="text-lg">
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Law enforcement</h1>
          <p className="text-lg">
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Security of Your Personal Data</h1>
          <p className="text-lg">
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Links to Other Websites</h1>
          <p className="text-lg">
        ...
        {/*  */}
        <div>
          <h1 className="text-4xl mb-2">Changes to this Privacy Policy</h1>
          <p className="text-lg">
